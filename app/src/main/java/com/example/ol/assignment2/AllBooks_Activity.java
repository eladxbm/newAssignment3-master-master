...
public class AllBooks_Activity extends AppCompatActivity{
    ...
    private void FilterBooks() {
        ...
        upArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                numOfMinReviews = numOfMinReviews + 1;
                txtMinReviews.setText(Integer.toString(numOfMinReviews));
            }
        });
        downArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(numOfMinReviews>0) {
                    numOfMinReviews = numOfMinReviews - 1;
                    txtMinReviews.setText(Integer.toString(numOfMinReviews));
                }
            }
...
btnSubmitFilter.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        {//add numOfReviews
            if(book.getPrice()<=maxPriceFilter)
